...
RUN DEBIAN_FRONTEND=noninteractive apt -qqy install git curl authbind tor obfs4proxy psmisc build-essential python3-pip libcurl4-openssl-dev libssl-dev xvfb tk-dev python3-tk
