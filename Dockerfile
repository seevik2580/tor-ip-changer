...
RUN apt -y purge subversion libcurl4-openssl-dev libssl-dev python3-pip tk-dev build-essential
RUN apt -y autoremove && apt -y clean && rm -rf /var/lib/apt/lists/* && rm -rf /root/.cache/*
